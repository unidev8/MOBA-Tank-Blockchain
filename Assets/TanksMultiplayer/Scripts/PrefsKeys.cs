...
namespace TanksMP
{
    ...
    public class PrefsKeys
    {
        ...
        public const string map = "Map-1";

        //royal info
        public const string royalTeamCount = "royalTeamCount";
        public const string royalTeamMemberCount = "royalTeamMemberCount";
        public const string royalMapIndex = "Map-4 Index";
    }
}
