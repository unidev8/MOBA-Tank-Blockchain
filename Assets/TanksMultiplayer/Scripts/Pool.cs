...
namespace TanksMP
{
    ...
    public class Pool : MonoBehaviour
    {
        ...
        public GameObject Spawn(Vector3 position, Quaternion rotation, Transform parent = null)
        {
            ...
            obj.BroadcastMessage("OnSpawn", new object[]{gameObject.transform, parent}, SendMessageOptions.DontRequireReceiver);
        ...
        IEnumerator DespawnInTime(PoolTimeObject timeObject)
        {
            ...
            while (instance == null || (instance.activeInHierarchy && Time.time < timer))
                yield return null;
